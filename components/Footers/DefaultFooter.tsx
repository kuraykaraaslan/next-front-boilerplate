...
const DefaultFooter = () => {
  ...
  return (
    <>        <footer className="footer px-20 py-10 bg-white text-center border-t border-gray-400">
      <nav>
      ...
      <footer className="footer px-10 py-4 bg-white text-center border-t border-gray-400">
