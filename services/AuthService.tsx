...
export class AuthService {
    ...
    static async initialize(ZustandStore: any, SessionStorage: any, Toast: any, Navigation: any) {
        AuthService.ZustandStore = ZustandStore;
        AuthService.SessionStorage = SessionStorage;
    ...
    static async register(email: string, password: string, confirmPassword: string): Promise<any> {
        ...
        const response = await AuthService.AxiosInstance.post('/v1/auth/register', { email, password }).then((response: any) => {
